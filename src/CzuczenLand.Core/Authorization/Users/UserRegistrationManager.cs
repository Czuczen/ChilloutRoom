...
public class UserRegistrationManager : DomainService
{
    ...
    private void CheckForTenant()
    {
        ...
        {
            throw new InvalidOperationException("Nie można zarejestrować użytkowników hosta!");
        }
    }
    ...
    private async Task<Tenant> GetActiveTenantAsync(int tenantId)
    {
        ...
        if (tenant == null)
        {
            throw new UserFriendlyException("Nieznany identyfikator najemcy: " + tenantId);
        }

        if (!tenant.IsActive)
        {
            throw new UserFriendlyException("Identyfikator najemcy nie jest aktywny: " + tenantId);
        }
